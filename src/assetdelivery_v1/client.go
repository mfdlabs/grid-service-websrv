...
// APIClient manages communication with the Asset Delivery Api v1 API vv1
...
func parameterValueToString( obj interface{}, key string ) string {
	...
	var param,ok = obj.(httpclients.MappedNullable)
	if !ok {
		return ""
	}
...
func parameterAddToHeaderOrQuery(headerOrQueryParams interface{}, keyPrefix string, obj interface{}, collectionType string) {
	...
	if v == reflect.ValueOf(nil) {
		...
		switch v.Kind() {
			...
			case reflect.Struct:
				if t,ok := obj.(httpclients.MappedNullable); ok {
					dataMap,err := t.ToMap()
					if err != nil {
						return
					}
